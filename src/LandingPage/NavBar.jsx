...
export default function NavBar({ onSignInClick, onSignUpClick, onLogoutClick, isLoggedIn, onBackToHome }) {
  return (
    <nav className={styles.navEL}>
      ...
      {isLoggedIn ? (
        <button onClick={onLogoutClick} className={styles.logoutBtn} alt="free trial button">Log Out</button>
      ) : (
        <>
